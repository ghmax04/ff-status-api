...
class FF_CLIENT(threading.Thread):
    ...
    def GET_LOGIN_DATA(self,JWT_TOKEN,PAYLOAD):
        url="https://client.ind.freefiremobile.com/GetLoginData";headers={'Expect':'100-continue','Authorization':f'Bearer {JWT_TOKEN}','X-Unity-Version':'2018.4.11f1','X-GA':'v1 1','ReleaseVersion':'Ob52','Content-Type':'application/x-www-form-urlencoded','User-Agent':'Dalvik/2.1.0 (Linux; U; Android 9; G011A Build/PI)','Host':'clientbp.ggblueshark.com','Connection':'close','Accept-Encoding':'gzip, deflate, br',};max_retries=3;attempt=0
    ...
    def TOKEN_MAKER(self,OLD_ACCESS_TOKEN,NEW_ACCESS_TOKEN,OLD_OPEN_ID,NEW_OPEN_ID,id):
        headers={'X-Unity-Version':'2018.4.11f1','ReleaseVersion':'Ob52','Content-Type':'application/x-www-form-urlencoded','X-GA':'v1 1','Content-Length':'928','User-Agent':'Dalvik/2.1.0 (Linux; U; Android 7.1.2; ASUS_Z01QD Build/QKQ1.190825.002)','Host':'loginbp.ggblueshark.com','Connection':'Keep-Alive','Accept-Encoding':'gzip'};data=bytes.fromhex('');data=data.replace(OLD_OPEN_ID.encode(),NEW_OPEN_ID.encode());data=data.replace(OLD_ACCESS_TOKEN.encode(),NEW_ACCESS_TOKEN.encode());hex=data.hex();d=encrypt_api(data.hex());Final_Payload=bytes.fromhex(d);URL="https://loginbp.ggblueshark.com/MajorLogin";RESPONSE=requests.post(URL,headers=headers,data=Final_Payload,verify=False)
